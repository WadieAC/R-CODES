#Generación de datos para entrenar la red.

'Genero los datos para crear mi red neuronal - datos circulares'
...
#Ya he generado mis datos circulares para entrenar mi modelo de clasificación los guardo en 2 variables
